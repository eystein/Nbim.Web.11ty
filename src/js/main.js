...
if (
    ...
    (typeof window === 'object' && window.netlife.useSentry === true)
) {
    ...
    if (typeof document.body === "object") {
        ...
        sentryScript.integrity = "sha384-uFON5MXfE3NkWO60hM8JaXAYAV0fqTCQbdy282z8YfelqBoXx+F7JFzX6+WfFIML";
        ...
        sentryScript.onload = () => {
            ...
            Sentry.init({
                dsn:
                    "https://7274037bb6fe488a81181f87af9203ee@o205316.ingest.sentry.io/1322851",
            });
            // eslint-disable-next-line
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (isIE11) {
        ...
        const nbimScrollUpButtonEl = document.getElementById(
            "nbimScrollUpButton"
        );
